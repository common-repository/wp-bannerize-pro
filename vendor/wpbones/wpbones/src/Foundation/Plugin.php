...
use WPBannerize\WPBones\Foundation\Log\LogServiceProvider;
use WPBannerize\WPBones\Routing\AdminMenuProvider;
use WPBannerize\WPBones\Routing\AdminRouteProvider;
use WPBannerize\WPBones\Routing\API\RestProvider;
use WPBannerize\WPBones\Routing\Pages\PageProvider;
...
/**
 * @class   Plugin
 * @package WPBannerize\WPBones\Foundation
 *
...
class Plugin extends Container implements PluginContract
{
    ...
    {
        // simulate __FILE__
        $this->file = $this->basePath . '/wp-bannerize.php';
         ...
         * Description = "WPBannerize is a WP Bones boilerplate plugin"
