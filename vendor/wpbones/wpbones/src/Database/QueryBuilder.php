...
use WPBannerize\WPBones\Database\Support\Collection;
use WPBannerize\WPBones\Database\Support\Model;
...
class QueryBuilder
{
   ...
   *
   * @var \WPBannerize\WPBones\Database\Support\Collection
   */
  private $collection = [];
   ...
   * @return \WPBannerize\WPBones\Database\QueryBuilder
   */
